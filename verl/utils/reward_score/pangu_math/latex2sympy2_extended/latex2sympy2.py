...
class _Latex2Sympy:
    def __init__(self, variable_values: Union[dict, None] = None, is_real=None, convert_degrees: bool = False, config: ConversionConfig = ConversionConfig()):
        # Instance variables
...
def latex2sympy(latex_str: str, variable_values: Union[dict, None] = None, is_real=None, convert_degrees: bool = False, normalization_config: Union[NormalizationConfig, None] = NormalizationConfig(), conversion_config: ConversionConfig = ConversionConfig()):
...
if __name__ == "__main__":
    ...
    print(latex2sympy(r"\boxed{\\dfrac{\\cos x}{2\\lnx \\cdot x^{\\ln x - 1}}}"))
